$(function () {
    ...
    //由于商品添加和编辑使用的是同一个页面
    //该标识符用来标明本次是添加还是编辑操作
    var backUrl='/shopadmin/shopoperation?shopId='+shopId;
    var isEdit = false;
    ...
    //
    $('#back').attr('href', '/shopadmin/productmanagement?shopId=' + shopId);
    ...
    //针对商品详情图控件组,若该控件组的最后一个元素发生变化（上传图片）
    //且控件总数未达到6个，则生成新的以恶搞文件上传控件
